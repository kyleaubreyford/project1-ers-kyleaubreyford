...
public class ReimbursementServiceImpl implements ReimbursementService {
	...
	public boolean approveReimbursement(int index,String approver) {
		return rd.approveReimbursement(index,ud.findByUsername(approver).getId());
		
	}
	
	@Override
	public boolean rejectReimbursement(int index,String approver) {
		return rd.rejectReimbursement(index,ud.findByUsername(approver).getId());
